...
<header class="slide-resp">
    ...
    <div class="slide-inner">
        <div class="slide-item">
            ...
            <img class="img-fundo" src="<?= base_url('assets/img/curso/'.$curso->ds_imgCurso) ?>" alt="">
        </div>
            ...
            ?>
                    ...
                    <div class="col-lg-4 col-sm-6 col-12 py-4">
                        <p class="text-center p-2 m-0" style="color: #FFF; border: 1px solid #FFF; border-radius:3px">
                            ...
                            <a href="<?= base_url('Usuario/login') ?>" class="btn btn-primary  mt-2">Acessar Conta <i class="fa fa-user"></i></a>
                        </p>
                    </div>
            <?php
                }else{
